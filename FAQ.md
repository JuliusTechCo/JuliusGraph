...
1. **Are the intermediate results in the computational DAG cached by Julius?**
    ...
    Yes, Julius automatically caches the intermediate results for every node in the computational DAG. The cached results are tremendously useful to both developers and users. This includes the ability to:
